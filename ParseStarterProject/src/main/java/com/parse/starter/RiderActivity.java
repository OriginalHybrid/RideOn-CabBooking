...
public class RiderActivity extends FragmentActivity implements OnMapReadyCallback {
                                        ...
                                        if (distanceInMiles < 0.125) {
                                            ...
                                            handler.postDelayed(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    callUberButton.setImageResource(R.drawable.calltaxi);
                                                    requestActive = false;
                                                    driverActive = false;
                    ...
                    request.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            ...
                            if (e == null) {
                                ...
                                callUberButton.setImageResource(R.drawable.canceltaxi);
                                requestActive = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callUberButton = (ImageButton) findViewById(R.id.callUberButton);
